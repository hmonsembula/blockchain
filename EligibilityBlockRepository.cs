...
{
    public class EligibilityBlockRepository : IEligibilityBlockRepository
    {
        private readonly IMongoCollection<IBlockChain> _collection;
        public EligibilityBlockRepository(IEligibilityBlockRepositorySettings repositorySettings)
        {
